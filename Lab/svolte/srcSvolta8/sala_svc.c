...
main (int argc, char **argv)
{
	...
	// a quanto pare le funzioni eseguono nell'environment in cui sono definite, quindi in questo caso seppur io stia chiamando
	// inizializza all'interno dello stub, in cui NON ho visibilità della sala, inizializza() riesce a vederla lo stesso per questo motivo.
	inizializza();
