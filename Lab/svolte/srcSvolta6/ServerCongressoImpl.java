...
public class ServerCongressoImpl extends UnicastRemoteObject implements
  ...
  public static void main(String[] args) {
    // creazione e inizializzazione struttura dati
    ...
    try {
      ...
      if( registryRemoto.aggiungi(serviceName, serverRMI) ) {
        System.out.println("Server RMI: Servizio \"" + serviceName + "\" registrato");
      } 
      else{
        System.out.println("Server RMI: Servizio \"" + serviceName + "\" NON registrato. Registry remoto pieno :( ");
      }
    } catch (Exception e) {
