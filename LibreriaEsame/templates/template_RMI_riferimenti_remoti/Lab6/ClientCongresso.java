...
class ClientCongresso {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/* OTTENGO IL RIFERIMENTO AL REGISTRY REMOTO */
			RegistryRemotoTagClient registryRemoto = (RegistryRemotoTagClient) Naming.lookup(completeRemoteRegistryName);
			
			/* RECUPERO DALL'UTENTE LE INFORMAZIONI NECESSARIE A FARE LA LOOKUP SUL REGISTRY REMOTO */
			//scelta del servizio
			...
			/* OTTENGO IL RIFERIMENTO AL SERVITORE UTILIZZANDO IL REGISTRY REMOTO */
			ServerCongresso serverRMI = (ServerCongresso) registryRemoto.cerca(nomiServizi[indiceServizio-1]);
			System.out.println("ClientRMI: Servizio \"" + serviceName + "\" connesso");


			/* UTILIZZO NORMALE DEL SERVITORE RECUPERATO */
